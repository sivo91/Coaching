       ...
       <div className="cotainer-fluid overflow-hidden">
         ...
         <div className="row d-flex justify-content-center my-3">
            <div className="col-3 col-md-1">
             <div>
               <img src="/imgs/brondz.jpg" className="img-fluid" alt="tncup"></img>
             </div>
            </div>
            <div className="col-3 col-md-1">
             <div>
        ...
        <div className="row justify-content-center">
         ...
         <div className="text-center">
              <img src="/imgs/record.jpg" className="img-fluid" alt="tncup"></img>
          </div>
          ...
          <div className="text-center">
            ...
            ></iframe>
             ...
             <p>My career later expanded to the USA, where I became the first player of the
       ...
       <div className="row d-flex justify-content-center my-5">
        ...
        <div className="row justify-content-center">
          <div className="col-11 col-md-6">
             ...
             <div className="text-center">
              <img src="/imgs/akcup.png" className="img-fluid" alt="tncup"></img>
             </div>
         ...
         <div className="row d-flex justify-content-center my-3">
            <div className="col-3 col-md-1">
             <div>
               <img src="/imgs/akk1.jpg" className="img-fluid" alt="tncup"></img>
             </div>
            </div>
            <div className="col-3 col-md-1">
             <div>
               <img src="/imgs/akk2.jpg" className="img-fluid" alt="tncup"></img>
             </div>
            </div>
            <div className="col-3 col-md-1">
             <div>
               <img src="/imgs/akk3.jpg" className="img-fluid" alt="tncup"></img>
             </div>
            </div>
         </div>
         ...
         <div className="row justify-content-center">
          <div className="col-11 col-md-6">
              ...
              <div className="text-center">
              <img src="/imgs/total.jpg" className="img-fluid" alt="tncup"></img>
             </div>

             <p>Overall, I played 1,077 professional games and accumulated 639 points. I was the top scorer on my team 4 times and finished 5 seasons with the most points among my teammates. In my last year in the ECHL, I also served as a layer-assistant coach in Tulsa Oilers.</p>
